...
Route::get('/post_edit_page/{id}',[HomeController::class, 'post_edit_page'])->middleware('auth');
Route::post('/edit_post_data/{id}',[HomeController::class, 'edit_post_data'])->middleware('auth');
